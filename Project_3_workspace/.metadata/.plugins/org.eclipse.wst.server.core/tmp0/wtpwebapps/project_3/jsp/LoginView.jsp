...
.grad{
background-image: url('<%=ORSView.APP_CONTEXT%>/img/geeta.jpg');
...
.p4 {
	 background-image: url('<%=ORSView.APP_CONTEXT%>/img/chrakvuy0222.jpg'); 
 		<%-- background-image: url('<%=ORSView.APP_CONTEXT%>/img/shinchan.jpg'); --%>
