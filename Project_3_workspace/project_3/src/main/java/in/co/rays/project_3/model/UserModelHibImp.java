...
public class UserModelHibImp implements UserModelInt {
	...
	public void update(UserDTO dto) throws ApplicationException, DuplicateRecordException {
		...
		System.out.println("Inside userhibimplementation " + dto.getLogin());
		//System.out.println("Inside userhibimplementation in exist dto......." + existDto.getLogin());
		// Check if updated LoginId already exist
		if (existDto != null && existDto.getId() != dto.getId()) {
			System.out.println("Inside userhibimplementation in if.........." + dto.getLogin());
...
//		map.put("login", userData.getLogin());
		map.put("login", "khushalirathod700@gmail.com");
